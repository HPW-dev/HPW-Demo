...
lib_path = ARGUMENTS.get('LIB_PATH', '')
used_libs = ARGUMENTS.get('USED_LIBS', '')
defines = ARGUMENTS.get('DEFINES', '')
ld_flags = ARGUMENTS.get('LD_FLAGS', '')
cxx_flags = ARGUMENTS.get('CXX_FLAGS', '')
inc_path = ARGUMENTS.get('INCLUDE_PATH', '')
