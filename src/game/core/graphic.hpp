...
// прочее:
inline std::string_view TEST_IMAGES_DIR    {"graphic/images/misc/test images/"}; // путь до папки тестовых пикч
inline std::string_view DEFAULT_TEST_IMAGE {"graphic/images/misc/test images/cube.png"};
