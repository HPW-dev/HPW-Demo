...
// прочее:
inline std::string_view TEST_IMAGES_DIR    {"resources/image/other/test images/"}; // путь до папки тестовых пикч
inline std::string_view DEFAULT_TEST_IMAGE {"resources/image/other/test images/cube.png"};
