...
void load_fonts() {
  ...
  auto mem = load_res("resources/font/unifont-13.0.06.ttf");
  ...
  init_unique<Microfont_mono>(graphic::asci_3x5, "resources/font/microfont mono/downcase.yml");
  init_unique<Microfont_mono>(graphic::asci_5x5, "resources/font/microfont mono/upcase.yml");
}
