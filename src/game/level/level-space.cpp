...
struct Level_space::Impl {
  ...
  inline Impl()
    : m_bg{"graphic/images/levels/space/bg.zip", Vec{}, 0.025, &blend_fade_out_max}
    , m_galaxy_1{"graphic/images/levels/space/galaxy 1.zip", Vec{}, 0.1, &blend_max}
    , m_galaxy_2{"graphic/images/levels/space/galaxy 2.zip", Vec{}, 0.025001, &blend_fade_out_max}
    , m_galaxy_3{"graphic/images/levels/space/galaxy 3.zip", Vec{}, 0.05, &blend_max}
  {
    hpw::shmup_mode = true;
    init_collider();
    make_player();
