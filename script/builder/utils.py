...
import script.builder.distr.util as compiler_util
...
def extract_includes(file_path: str, max_lines=100):
...
def init_env():
  ...
  env["compiler_ver"] = compiler_util.compiler_version(env)
...
def traceback_fileline(ex: Exception):
  '''вытащить имя файла и номер строки ошибки из исключения'''
  tb = ex.__traceback__
